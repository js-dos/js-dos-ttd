/* $Id: 8bpp_optimized.cpp 24004 2012-03-04 16:38:05Z rubidium $ */
...
{
	/* Quick access fields (for emscripten) */
	int bp_pitch = bp->pitch;
	int bp_skip_left = bp->skip_left;
	int bp_width = bp->width;
	int bp_height = bp->height;
	int bp_skip_top = bp->skip_top;
	const uint8 *bp_remap = bp->remap;
